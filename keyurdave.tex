...
\def\mybibliocommand{}
\def\mysubtitle{}
\def\myaffiliation{QIMR Berghofer Medical Research Institute}
\def\myaddress{protein discovery centre}
\def\myemail{keyur.dave@qimrberghofer.edu.au}
\def\myweb{http://www.kieranhealy.org}
\def\myphone{(+61) 07 38453661}
\def\myfax{(+61) 07 38453661}
...
\def\mykeywords{Keyur, Dave, Keyur Dave, Vita, CV, Resume, Proteomics}
...
\begin{minipage}[t]{2.95in}
 ...
 \href{http://www.qimrberghofer.edu.au/lab/protein-discovery-centre/}{protein discovery centre}, \\ 300 herston road\\ herston \\ \vspace{-0.05in} brisbane, \textsc{qld} 4006.}  
...
%% Name 
\noindent{\LARGE\scheader \textsc{keyur dave}}
\reversemarginpar
